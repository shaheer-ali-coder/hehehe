...
const TOKEN = '6803479292:AAEYannDdR2pb4QaNybJYWcwKLwsagnQLts'; // Replace with your actual bot token
...
bot.on('message', (message) => {
    ...
    if (message.text === "/start") {
        ...
        const initialMessage = `
            Welcome to DONGbot  \n\nSolana's fastest bot to trade any coin (SPL token), and DONGbot .\n\nYou currently have no SOL balance. To get started with trading, send some SOL to your DONGbot  wallet address:\n\n${wallet_address}\n\nOnce done tap refresh and your balance will appear here.\n\nTo buy a token just enter a token address, or even post the birdeye link of the coin.\n\nFor more info on your wallet and to retrieve your private key, tap the wallet button below. We guarantee the safety of user funds on DONGbot , but if you expose your private key your funds will not be safe.`;
...
bot.on('callback_query', (query) => {
    ...
    switch (callbackData) {
        ...
        case 'reset':
            ...
            bot.sendMessage(chatId , "Are you sure you want to reset your DONGbot  Wallet?\n\nWARNING: This action is irreversible!\n\nDONGbot  will generate a new wallet for you and discard your old one.",{
                parse_mode : "HTML",
                ...keyboard_3
            })
            break
...
sellSolana(wallet, privateKey, tokenAccountAddress, amountToSell);
        ...
        case 'referral_system':
            ...
            break;
        case 'transfer_sol':
            bot.sendMessage(chatId,`Here is the link for our Alert Channel : https://t.me/DONKEYDONGBOT`)
            break;
        case 'max_price':
